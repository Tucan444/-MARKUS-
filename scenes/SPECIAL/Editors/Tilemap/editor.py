...
class TilemapEditor(SceneBehaviour):
    def __init__(self, game, scene, active, order):
        ...
        self.shelves_manager: 'ShelvesManager' | None = None

        self.enforce_different_layer: bool = True
        self.save_compact: bool = True
    ...
    def init(self):
        ...
        self.shelves_manager = self.scene.classes["ShelvesManager"](self)
    ...
    @property
    def offgrid(self) -> bool:
        return not self.tile_placer.placing_on_grid

    def add_grid(self, _) -> None:
    ...
    def remove_selected_grid(self, _) -> None:
